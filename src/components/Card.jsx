...
function Card({id,values}) {
  ...
  return (
    <>
    <div className=' max-sm:mx-auto mt-3 cursor-pointer  xl:mx-auto w-[300px]  border  border-gray-400 rounded  p-2 ' onClick={()=>navigate(`/productdetails?pdt=${id}`)}>
        <div className=' h-[160px] p-1' style={{
          ...
          backgroundPosition: 'center',
            ...
            {/* <img src={values.image} className='object' /> */}
        </div>
        <div className='overflow-hidden'>
            <div className='font-bold w-full text-2xl '>₹{formatPrice(values.price)}</div>
